...
scope_guideline = Guidelines(
    name="stays_in_scope",
    guidelines=[
        "The response must only discuss topics related to Global Findex reports and research",
        "The response should not answer questions about unrelated topics",
        "If asked about non-research topics, politely redirect to Global Findex-related questions",
    ],
    model="databricks:/databricks-gpt-oss-120b",
)
...
def mentions_papers(outputs: list) -> bool:
    ...
    keywords = ["report", "study", "research", "Global Findex", "author", "published"]
