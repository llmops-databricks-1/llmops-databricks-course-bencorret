...
from global_findex_curator.evaluation import (
...
# Using pre-defined Guidelines scorer from global_findex_curator.evaluation
# The polite_tone_guideline is already imported from our package
# It includes guidelines for polite and professional tone

logger.info("Using Guidelines Scorer from global_findex_curator.evaluation:")
