...
def function_with_metadata(x: int, y: int) -> int:
    ...
    mlflow.update_current_trace(
        ...
        tags={
            "model_serving_endpoint_name": "global-findex-agent-endpoint",
            "model_version": "1",
            "git_sha": git_sha,
...
# Test with real LLM
result = call_real_llm("What is the impact of the rise of formal savings?")
...
endpoint_traces = mlflow.search_traces(
    filter_string="tags.model_serving_endpoint_name = 'global-findex-agent-endpoint'",
    max_results=5,
)
